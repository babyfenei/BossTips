...
local BossData = {
    ...
    ["水闸行动"] = {
        ...
        ["泡泡"] = {
            tips = "{rt8}泡泡{rt8}||开怪之前集合站位方便让第一波水球放在一起||{rt1}逆流{rt1}注意开减伤爆发群刷抬血||T拉怪远离地上的水球||骑士无敌等技能可以在第二波水球出现后将水球全部踩掉",
        },
        ["风险投资公司电工"] = {
    ...
    ["塔扎维什，帷纱集市"] = {
        ...
        -- 琳彩天街
        ["大门看护者佐·马兹"] = {
            tips = "{rt8}大门看护者佐·马兹{rt8}||[代理打击]打T技能，T注意开减伤。所有人躲地板技能。||[辐射脉冲]AOE技能注意抬团血。",
        },
        ["海关保安"] = {
            tips = "{rt8}海关保安{rt8}||[干扰手雷]地板技能注意躲开。",
        },
        ["装甲监工"] = {
            tips = "{rt8}装甲监工{rt8}||[代理打击]打T技能，T注意开减伤。所有人躲地板技能。||[光线切分者]T拉怪远离光球，所有人躲开光球的射线",
        },
        ["审讯专员"] = {
            tips = "{rt8}审讯专员{rt8}||[约束雕文]必须打断。",
        },
        ["支援警官"] = {
            tips = "{rt8}支援警官{rt8}||[折射护盾]反伤盾能进攻驱散的最好驱散，[强光屏障]给其他怪加盾必须打断，[棱光箭]尽量打断。",
        },
        ["传送门操控师佐·达赫"] = {
            tips = "{rt8}传送门操控师佐·达赫{rt8}||躲开所有地板技能和连线，||[强化约束雕文]必须打断||[辐射脉冲]AOE技能注意抬团血。",
        },
        ["追踪者佐·刻斯"] = {
            tips = "{rt8}追踪者佐·刻斯{rt8}||[监管锁链]强制所有人在怪10码内，[光线切分者]范围技能，每出一个 T带怪依次远离。",
        },
        ["上古熔火恶犬"] = {
        ...
        ["赛·达利德"] = {
            tips = "{rt8}赛·达利德{rt8}||点击这个怪，拾取地上掉落的道具，根据拾取的道具类型送到对应的NPC跟前||好像要送3次，新版本目标NPC是高亮的，必须打断。||【卖场铁腕战士】出现后最好丢掉道具，防止被怪集火，打完再捡起来||最好让有WA的拾取道具||WA地址https://wago.io/F2StJKSFw",
        },
        ["指挥官佐·法"] = {
        ...
        -- 索·莉亚的宏图
        ["踏滨巨人"] = {
            tips = "{rt8}踏滨巨人{rt8}||[海潮践踏]高额AOE注意抬血开减伤，躲开地上其他小怪的地板技能||[投掷巨石]的黄圈躲开，否则晕2秒。||转火小怪招的鱼串或者T拉走。||鱼人残血会乱跑注意控制或集火||不要去河边的水里会被鲨鱼咬",
        },
        ["浊盐缚鳞者"] = {
            tips = "{rt8}浊盐缚鳞者{rt8}||[活力鱼串]出了以后第一时间转火，或者T拉这怪远离鱼串。||鱼串只能被单体技能打掉",
        },
        ["雷铸守护者"] = {
            tips = "{rt8}雷铸守护者{rt8}||[连环爆裂][充能脉冲]||P1的单点会穿糖葫芦一键三连所以谁被点了不要站一条线上||P2会三连击点名也注意不要被穿糖葫芦||距离万磁臂越近伤害越高注意别被秒掉||T不在近战范围之内会直接灭团。",
        },
        ["肌肉虬结的水手"] = {
            tips = "{rt8}肌肉虬结的水手{rt8}||[超级塞松啤酒]会加50%伤害打T，T注意减伤或者放风筝。硬控可以打断。",
        },
        ["时沙号海潮贤者"] = {
            tips = "{rt8}时沙号海潮贤者{rt8}||[海潮爆发]必须躲开，否则击飞。[盐渍飞弹]必须打断。",
        },
        ["盛装的星辰先知"] = {
            tips = "{rt8}盛装的星辰先知{rt8}||[游移之星]必须躲开头前路径。[流浪的脉冲星]召唤的小球必须第一时间集火秒杀。",
        },
        ["专心的祭师"] = {
            tips = "{rt8}专心的祭师{rt8}||[凌光箭]打T技能尽量断。[不稳定的裂隙]必须打断，否则灭团。||[重焕活力]必须打断，否则回满血",
        },
    },
    ...
    ["赎罪大厅"] = {
        ...
        -- 小怪部分
        ["堕落的驯犬者"] = {
            tips = "{rt8}堕落的驯犬者{rt8}||[[忠心的野兽]]能打断尽量打断，否则两只野兽打T很疼。",
        },
        ["堕落的歼灭者"] = {
            tips = "{rt8}堕落的歼灭者{rt8}||[[[湮灭诅咒]]]8码AOE技能，诅咒可以驱散",
        },
        ["石裔切割者"] = {
            tips = "{rt8}石裔切割者{rt8}||[猛力横扫]躲开头前技能，[瓦解尖叫]法系注意停止施法否则沉默。||[石拳]打T并击飞，T注意减伤并调整方向",
        },
        ["石裔掠夺者"] = {
            tips = "{rt8}石裔掠夺者{rt8}||[致死打击]打T技能，T注意覆盖减伤。||[变为石头]躲开技能圈防止石化。",
        },
        ["哈尔吉亚斯的碎片"] = {
            tips = "{rt8}哈尔吉亚斯的碎片{rt8}||躲地板，打断小怪的[收集罪恶]，驱散诅咒，全程AOE治疗注意抬血",
        },
        ["劳苦的管理员"] = {
            tips = "{rt8}劳苦的管理员{rt8}||这个怪残血会乱跑注意控制防止ADD。",
        },
        ["支援警官"] = {
            tips = "{rt8}支援警官{rt8}||[折射护盾]反伤盾能进攻驱散的最好驱散，[强光屏障]给其他怪加盾必须打断，[棱光箭]尽量打断。",
        },
        ["审判官西加尔"] = {
            tips = "{rt8}审判官西加尔{rt8}||躲地板，中圈分散站，起手不要直接打大怪。||先清房间的小怪等BOSS第一次吸血完成后打BOSS，BOSS没血的时候会吸取房间所有怪来回血||吸血后会召唤小怪需要T群嘲A掉，在大怪吸血前尽量打掉所有黄名怪，适当可以在这里交嗜血",
        },
    },    
