...
local BossData = {
    ...
    ["通灵战潮"] = {
        ["凋骨"] = {
            tips = "{rt1}凋骨{rt1}||{rt3}将呕吐物对准远离团队的方向||{rt3}远离被点吐息的目标||{rt3}杀小怪||{rt3}躲开地板技能。",
        },
        ["阿玛厄斯"] = {
            tips = "{rt1}阿玛厄斯{rt1}||{rt3}打断BOSS||{rt3}打断FS小怪，聚好小怪快速杀掉||{rt3}躲避亡者领域||{rt3}BOSS定期会吐息冰旋转，DPS N提前躲避到BOSS身后。",
        },
        ["外科医生缝肉"] = {
            tips = "{rt1}外科医生缝肉{rt1}||{rt3}中肉钩点名的，站到小怪和BOSS中间，让箭头对准BOSS，读条到1的时候闪开||{rt3}BOSS被拉下来开爆发||{rt3}即时BOSS不在台上也要用肉钩对准BOSS来打断凝视||{rt3}BOSS快上台子时中肉钩可提前瞄准台子。",
        },
        ["缚霜者纳尔佐"] = {
            tips = "{rt1}缚霜者纳尔佐{rt1}||{rt3}(1) 躲避漩涡。||{rt3}(2) 如果有人被冰冻，尽快离开他们的圆圈。在大圆圈为空之前不要驱散。圈内有人驱散会传染||{rt3}(3) 如果被传送走，尽快跑下通道开位移技能躲避地图白圈并击杀怪物||{rt3}4）完成后点NPC上来加100%暴击40秒，50秒后没上来直接秒杀||{rt3}(5) 当你回来时，站在边缘放置冰块。",
        },
     },
    ["尼鲁巴尔王宫"] = {
          ["噬灭者乌格拉克斯"] = {
