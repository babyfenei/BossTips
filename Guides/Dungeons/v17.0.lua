...
--      addon.GuideData.versionInfo["17.0"] = { label = "17.0 资料片名", order = 17 }
...
--      addon.GuideData.versions["17.0"] = addon.GuideData.versions["17.0"] or {}
--      addon.GuideData.versions["17.0"]["副本名"] = {
