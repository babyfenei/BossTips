...
--      addon.GuideData.versionInfo["16.0"] = { label = "16.0 资料片名", order = 16 }
...
--      addon.GuideData.versions["16.0"] = addon.GuideData.versions["16.0"] or {}
--      addon.GuideData.versions["16.0"]["副本名"] = {
