...
--      addon.GuideData.versionInfo["14.0"] = { label = "14.0 资料片名", order = 14 }
...
--      addon.GuideData.versions["14.0"] = addon.GuideData.versions["14.0"] or {}
--      addon.GuideData.versions["14.0"]["副本名"] = {
