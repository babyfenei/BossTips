...
--      addon.GuideData.versionInfo["13.0"] = { label = "13.0 资料片名", order = 13 }
...
--      addon.GuideData.versions["13.0"] = addon.GuideData.versions["13.0"] or {}
--      addon.GuideData.versions["13.0"]["副本名"] = {
