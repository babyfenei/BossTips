...
--      addon.GuideData.versionInfo["15.0"] = { label = "15.0 资料片名", order = 15 }
...
--      addon.GuideData.versions["15.0"] = addon.GuideData.versions["15.0"] or {}
--      addon.GuideData.versions["15.0"]["副本名"] = {
